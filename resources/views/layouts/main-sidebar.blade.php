...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('assets/img/brand/logo.jpg')}}" class="main-logo "  alt="logo"></a>
        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                    ...
                    @endcan
                    @can('المنتجات')
                    <li><a class="slide-item" href="{{ url('/' . $page='products') }}">االمنتجات</a></li>
                    @endcan
